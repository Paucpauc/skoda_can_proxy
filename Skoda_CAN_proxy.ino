...
void TaskReadVcc(void) {
  ...
  void TaskQueueHTTP(void) {
    ...
    if (pos.n == 0)
      return;
    sprintf_P(shared_buf, PSTR("AT+HTTPPARA=\"URL\",\"http://example.net/car/car.php?d=%s&la=%s&lo=%s&vcc=%d&s=%d&rpm=%d&spd=%d&f=%d&l1=%d&l2=%d&vcc_can=%d&can_last=%lu&qid=%d&t=%d\""),
